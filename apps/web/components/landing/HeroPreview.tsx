...
import { useShowcaseProject } from "@/hooks/useShowcaseProject";
...
export function HeroPreview() {
  const { project, loading } = useShowcaseProject();
  ...
  return (
    ...
    >
      {loading ? (
        <div className="flex aspect-[4/5] items-center justify-center rounded-[14px] bg-stone-900 sm:aspect-video">
